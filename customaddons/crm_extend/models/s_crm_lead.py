...
class SCrmLead(models.Model):
    ...
    def _get_user_id(self):
        ...
        get_team = self.env['crm.team'].search([('user_id', '=', current_user_id)]).ids
        get_member_team = self.env['crm.team.member'].search([('crm_team_id', '=', get_team)]).user_id.ids
        get_leader_id = self.env['crm.team'].search([('user_id', '=', current_user_id)]).user_id.ids
